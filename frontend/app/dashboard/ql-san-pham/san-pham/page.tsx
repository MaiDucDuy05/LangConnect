      ...
      <Card>
        <CardHeader className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-2">
          ...
          <div className="relative mt-2 sm:mt-0">
            ...
            <Input type="search" placeholder="Tìm kiếm sản phẩm..." className="pl-8 w-full sm:w-[250px]" />
          </div>
        </CardHeader>
        <CardContent>
              ...
              >
                <div className="flex items-start sm:items-center gap-4">
                  <div className="w-16 h-16 rounded bg-gray-100 flex items-center justify-center shrink-0">
                    <img
                      src={`/placeholder.svg?height=64&width=64&text=SP${item}`}
                      alt={`Sản phẩm ${item}`}
                      className="w-full h-full object-cover rounded"
                    />
                  </div>
                  <div>
                    <h3 className="font-medium">Sản phẩm y học cổ truyền #{item}</h3>
                    <div className="flex flex-wrap gap-x-4 text-sm text-gray-500 mt-1">
                      <span>Giá: {item * 100}.000đ</span>
                      <span>Kho: {item * 10} sản phẩm</span>
