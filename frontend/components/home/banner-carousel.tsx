          ...
          <div className="grid grid-cols-1  gap-4 h-[400px] md:h-[500px] ">
            ...
            <div className="relative overflow-hidden rounded-lg shadow-md">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <picture>
                    <source media="(max-width: 767px)" srcSet="/images/banner/1sm.jpg" />
                    <img
                  ...
                  {/* Flex column để có thể đẩy nội dung xuống */}
                  <div className="absolute inset-0 flex flex-col justify-end items-center">
                    <div className="text-white p-6 md:p-10 max-w-xl mb-[5%]">
                      <Button className="bg-green-700 hover:bg-green-800 h-[60px] w-[220px] rounded-[8px] text-2xl font-bold">
                        <Link href="/thay-lang">
                          Kết nối ngay
                        </Link>
                      </Button>
